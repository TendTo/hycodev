      ...
      >
        <AccordionItem>
          <h2>
            <AccordionButton pl={0}>
              <Box as="span" flex="1" textAlign="left">
                <h3 className={typography.heading_secondary}>Open Positions</h3>
              </Box>
          ...
          <AccordionPanel pb={4} className={styles.accordion__content}>
            <p className={typography.paragraph + " " + utilities.bot_margin}>
              I always look for excellent PhD students interested in model-based
              and data-driven analysis of cyber-physical systems (e.g.,
              autonomous systems modeled with dynamical equations). The main
              focus will be on the formal verification and synthesis of
              (stochastic) hybrid systems, i.e., dynamical systems exhibiting
              mixed discrete and continuous behaviour under the influence of
              uncertainty. Depending on the interest and background of
              candidates, research will include topics from control theory,
              probabilistic methods, logic, and machine learning.
            </p>
            <p
              className={
                typography.paragraph_highlighted +
                " " +
            ...
            <ul className={styles.list + " " + utilities.bot_margin}>
              <li className={typography.paragraph}>
                Strong background in Control Theory, Computer Science,
                Mathematics, or closely related fields. Should have completed,
                or about to complete, a Bachelor's or Master's degree in one of
                the these areas.
              </li>
              <li className={typography.paragraph}>
