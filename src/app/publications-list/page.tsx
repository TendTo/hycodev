    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.container__publication}>
                ...
                <div>
                    <h4 className={styles.publication_heading}>Adaptive and sequential gridding procedures for the abstraction and verification of stochastic processes</h4>
                    <p className={styles.publication_paragraph}><b>Authors:</b> Sadegh Esmaeil Zadeh Soudjani, Alessandro Abate</p>
                    <p className={styles.publication_paragraph}><b>Date:</b> 07/07/2023</p>
                </div>
                {/*<div>*/}
